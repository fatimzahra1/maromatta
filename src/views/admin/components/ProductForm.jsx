...
const brandOptions = [
  { value: 'Fatna', label: 'Fatna' },
  { value: 'Saida', label: 'Saida' },
  { value: 'Aicha', label: 'Aicha' },
        ...
        {({ values, setValues }) => (
          <Form className="product-form">
            <div className="product-form-inputs">
              ...
              <div className="product-form-field">
                <span className="d-block padding-s">Bildsamling</span>
                {!isFileLoading && (
            ...
            <div className="product-form-file">
              <div className="product-form-field">
                <span className="d-block padding-s">* Miniatyr</span>
                {!isFileLoading && (
