            ...
            <div  className="user-profile-block">
                ...
                <div  className="user-profile-details">
                    ...
                    {profile.address  ?  (
                        ...
                        <h5  className="text-subtle  text-italic">Adress  ej  angiven</h5>
                    )}
                    <span>Mobil</span>
                    <br  />
                    {profile.mobile  ?  (
                        ...
                        <h5  className="text-subtle  text-italic">Mobile  ej  angiven</h5>
                    )}
                    <span>Ansluten  datum</span>
                    <br  />
                    {profile.dateJoined  ?  (
                        <h5>{displayDate(profile.dateJoined)}</h5>
                    )  :  (
                        <h5  className="text-subtle  text-italic">Inte  tillgänglig</h5>
                    )}
                </div>
            </div>
        </div>
