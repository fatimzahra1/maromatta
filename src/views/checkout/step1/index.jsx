  ...
  return (
    <div className="checkout">
      ...
      <div className="checkout-step-1">
        <h3 className="text-center">Ordersammanfattning</h3>
        <span className="d-block text-center">Granska varor i din varukorg.</span>
        <br />
        ...
        <div className="basket-total text-right">
          <p className="basket-total-title">Delsumma:</p>
