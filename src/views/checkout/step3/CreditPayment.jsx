...
const  CreditPayment  =  ()  =>  {
    ...
    return  (
        <>
            <h3  className="text-center">Betalning</h3>
            <br  />
            <span  className="d-block  padding-s">Betalningalternativ</span>
            <div
                ref={containerRef}
                    ...
                    <div  className="checkout-checkbox-field"  ref={checkboxContainerRef}>
                        ...
                        >
                            <div  className="d-flex-grow-1  margin-left-s">
                                <h4  className="margin-0">Kreditkort</h4>
                                <span  className="text-subtle  d-block  margin-top-s">
                                    Betala  med  Visa,  Master  Card  och  andra  betal-  eller  kreditkort
                                </span>
                            </div>
