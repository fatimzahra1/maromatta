...
const Basket = () => {
  ...
  return user && user.role === 'ADMIN' ? null : (
    <Boundary>
      ...
      >
        <p className="text-center">Du måste logga in för att fortsätta att checka ut</p>
        <br />
      ...
      <div className="basket">
        <div className="basket-list">
          <div className="basket-header">
            ...
            <button
              ...
              type="button"
            >
              <span>Rensa korg</span>
            </button>
          </div>
          {basket.length <= 0 && (
            <div className="basket-empty">
              <h5 className="basket-empty-msg">Din varukorg är tom</h5>
            </div>
          )}
        ...
        <div className="basket-checkout">
          <div className="basket-total">
            <p className="basket-total-title">Delsumma belopp:</p>
